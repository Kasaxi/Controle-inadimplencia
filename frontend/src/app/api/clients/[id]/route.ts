...
export async function PUT(request: Request, context: RouteParams) {
    try {
        ...
        const validKeys: (keyof ClientUpdateInput)[] = ['name', 'cpf', 'contactNumber', 'overdueInstallments', 'address', 'responsible', 'observation', 'fileUrl', 'consultationDate', 'alertStatus', 'isNewClient', 'p1Paid', 'p2Paid', 'p3Paid', 'p4Paid', 'p5Paid', 'p6Paid'];
